...
urlpatterns = [
    ...
    path('favorites/<int:recipe_id>', views.FavoriteDelete.as_view(), name='favorite_delete'),
    path('subscriptions', views.Subscriptions.as_view(), name='subscriptions'),
    path('subscriptions/<int:author_id>', views.SubscriptionDelete.as_view(), name='subscription_delete'),
